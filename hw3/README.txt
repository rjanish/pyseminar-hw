...
This script assumes that it is run from a directory containing a subdirectory "hw_3_data/", which contains the data files "Efficiency.txt", "Purity.txt".  The plot will be written to "efficiency-purity.png".