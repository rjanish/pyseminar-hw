...
The primary module script CalCalc.py also implements the command line functionality.  This script will be placed into some packages directory depending on your python installation, likely something/lib/python2.7/site-packages/.  In order to use CalcCal.py from the command line while in any other directory, you must either add this directory to your shell search path, or you should link CalCalc.py to one of your bin directories. 
